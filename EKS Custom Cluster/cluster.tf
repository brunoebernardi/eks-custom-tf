...
resource "aws_eks_cluster" "k8scluster" {
  ...
  vpc_config {
    ...
    #Setting this value to false to prevent public access to this EKS cluster
    #If you need to access your application via NodePort, change this value to true
    #Is insecurity practice set this value to true. Note: https://aquasecurity.github.io/tfsec/v1.0.0-rc.1/checks/aws/eks/no-public-cluster-access/
